...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/seamm-dashboard-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14639&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/seamm-dashboard-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `seamm-dashboard` can be installed with:

```
conda install seamm-dashboard
```

It is possible to list all of the versions of `seamm-dashboard` available on your platform with:
